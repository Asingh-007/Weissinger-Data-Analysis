function [LHS_kutta_drag_matrix_x,LHS_kutta_drag_matrix_y, LHS_kutta_drag_matrix_z] = calc_induced_kutta_drag_matrix(x_vortex_1, x_vortex_2, y_vortex_1, y_vortex_2, z_vortex_1, z_vortex_2, sweep_angle, dihedral_angle, panel_number, aoa, aoa_0_dist, wake_alignment)

LHS_kutta_drag_matrix_x = zeros(panel_number, panel_number);
LHS_kutta_drag_matrix_y = LHS_kutta_drag_matrix_x;
LHS_kutta_drag_matrix_z = LHS_kutta_drag_matrix_x;
...
LHS_kutta_drag_matrix = x_horseshoe;
...
if sweep_angle == 0 && dihedral_angle == 0
    ...
    for i = 1:panel_number
        ...
        for j = 1:panel_number
            ...
            LHS_kutta_drag_matrix{i,j} = (1/(4*pi)) * (x_horseshoe{i,j} - y_horseshoe_1{i,j} + y_horseshoe_2{i,j});
            LHS_kutta_drag_matrix_x(i,j) = LHS_kutta_drag_matrix{i,j}(1);
            LHS_kutta_drag_matrix_y(i,j) = LHS_kutta_drag_matrix{i,j}(2);
            LHS_kutta_drag_matrix_z(i,j) = LHS_kutta_drag_matrix{i,j}(3);
