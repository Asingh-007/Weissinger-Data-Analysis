...
[wing_parameters, max_CL] = fminsearchbnd(@max_CL, [aspect_ratio; taper_ratio; geo_twist_angle; sweep_angle; dihedral_angle; flap_percent; flap_angle; aoa_tip_0; aoa_root_0],...
...
if export_optimization
    ...
    optimize_file_name = append(['Output\', 'Optimize_CL_Run_', num2str(randi([1000000000 9999999999],1)),'.xlsx']);
