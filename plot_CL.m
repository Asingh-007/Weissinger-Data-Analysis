function [cl_aoa] = plot_CL(y_control, lift_distribution, cl_distribution, total_cl_distribution, aoa_vector, freestream_velocity, wing_reference_area, wing_span, panel_number, array_index, wing_name, aoa_index, export_lift)
