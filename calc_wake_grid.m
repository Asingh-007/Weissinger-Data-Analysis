function[x_velocity, y_velocity, z_velocity] = calc_wake_grid(x_vortex_1, x_vortex_2, y_vortex_1, y_vortex_2, z_vortex_1, z_vortex_2, x_wake, y_mesh, z_mesh, panel_number, aoa, aoa_0_dist, wake_alignment, circulation, freestream_velocity)
...
for i = 1:panel_number
    ...
    r_bound_1 = [(x_wake(1) - x_vortex_1(i)); (y_mesh(1) - y_vortex_1(i)); (z_mesh(1) - z_vortex_1(i))];
    r_bound_2 = [(x_wake(1) - x_vortex_2(i)); (y_mesh(1) - y_vortex_2(i)); (z_mesh(1) - z_vortex_2(i))];
...
x_velocity = LHS_wake_drag_matrix_x * circulation + freestream_velocity * cosd(aoa - aoa_0_dist(1));
y_velocity = LHS_wake_drag_matrix_y * circulation;
z_velocity = LHS_wake_drag_matrix_z * circulation + freestream_velocity * sind(aoa - aoa_0_dist(1));