function plot_CL_non_linear(f, y_control, CL, CL_non_linear, total_CL, total_CL_non_linear, aoa_vector, aoa_sectional, decambering_angle, array_index, wing_name, do_aoa_labels, is_looped)
